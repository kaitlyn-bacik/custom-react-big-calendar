...
export default class Calendar extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedEvent : null,
      events        : [ 
           {id: 0, title: "long test event nameeeeeeee", start: moment().set("minutes", 0).toDate(), end: moment().set("minutes", 5).toDate(), startTime: moment().hours() * 3600, endTime: moment().hours() * 3600 + 5 * 60, recurringDays: [0, 1], desc: "Description", color: "#FF00FF", col: "#FF00FF"},
